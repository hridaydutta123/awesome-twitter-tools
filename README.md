...
+ [Xquik](https://xquik.com) ([GitHub](https://github.com/Xquik-dev/x-twitter-scraper)) - Real-time X (Twitter) data platform with REST API, MCP server, and webhooks — tweet search, user lookup, follower extraction, engagement metrics, giveaway draws, account monitoring, and 19 extraction tools.
